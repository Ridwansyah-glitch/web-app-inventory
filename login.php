...
<head>
    ...
    <link href="<?= $main_url ?>sb_admin/css/styles.css" rel="stylesheet" />
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            ...
                                            <button type="submit" class="btn btn-primary" href="index.html" name="login">Login</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?= $main_url ?>register.php">Need an account? Sign up!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
